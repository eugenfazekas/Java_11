...
public class StringArrayUtil {
	...
	public static String[]filterEmptyStringsWithFixedLength(String[]inputStringArray,int arraySize
			,String arrayNam) {
	...
	public static String[] filterEmptyStringsWithUnknownLength(String[] inputStringArray
			,String arrayNam) {
