...
public class BuildAudioImage {
	...
	public static BufferedImage buildSpectrogramImage(int id) {
	    ...
	    double maxMagnitude = AudioGramUtil.getMaxMagnitude(SpektroGramBuilder.spectrogram);
	...
	public static BufferedImage buildVoiceCompareImage(int[] map1, int[] map2, int height) {
	    ...
	    for (int x = 3; x < length*3; x=x+3) {
			...
			Debug.debug(5,"buildImage x2: "+x + " waveMap[x]: "+map2[x]+ ", map2[x+1]: "+map2[x+1]+ " waveMap.length: "+map2.length);
