...
public class VoiceRecognitionFrequencyRefinary implements MyThread, StreamRefinary{
	...
	public void run() {
		...
		Thread.currentThread().setName("VoiceRecognitionFrequencyRefinary");
	...
	public void bufferCheck(byte[] inputBuffer) {
        ...
        for (int i = StreamRefinaryAmplitudeMethods.loopStart; i < inputBuffer.length; i=i+2) {
        	...
        	StreamRefinaryFrequencyMethods.VRFR_buildMilisecFrequencyCheck(
        ...
        StreamRefinaryAmplitudeMethods.saveVoiceRecognitionStreamFrequencyToExamine();
