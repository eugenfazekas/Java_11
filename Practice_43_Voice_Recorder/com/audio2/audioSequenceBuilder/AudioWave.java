...
public class AudioWave {
	...
	public AudioWave(int positveAmplitude, int frequency, int milisecLength) {
	...
	public AudioWave(int frequency, int positveAmplitude, int posSampleCount,int negativeAmplitude,
			int negSampleCount) {
	...
	public String toString() {
		return "Sequence [positveAmplitude=" + positveAmplitude + ", negativeAmplitude=" 
			+ negativeAmplitude+ ", posSampleCount=" + posSampleCount + ", negSampleCount=" 
			+ negSampleCount + ", frequency="+ frequency + ", milisecLength=" + milisecLength +"]";
	}	
}
