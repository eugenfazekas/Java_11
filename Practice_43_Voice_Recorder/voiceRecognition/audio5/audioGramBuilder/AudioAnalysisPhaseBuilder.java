...
public class AudioAnalysisPhaseBuilder {
	...
	private static void buildMultiAnalysisPhase3() {
		...
		if(AppSetup.amplitudeGram && AppSetup.frequencyGram && AppSetup.mySpektrogram
				&& AppSetup.voiceRecognitionData && AppSetup.voiceRecognitionFrequencyGramData) {

			task = new Task() { public void makeTask() {MultiAnalysisBuilder.phase_3_BuildVoiceRecognitionFrequencyGramArray();};};
