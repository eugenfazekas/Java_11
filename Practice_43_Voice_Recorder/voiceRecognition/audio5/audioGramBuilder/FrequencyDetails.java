...
public class FrequencyDetails {
	...
	static void addToMultiFrequencyWaveMap(int[] frequencys) {
		 
		AGBCVariables.frequencyMultiWaveMap[AGBCVariables.frequencyMultiWaveMapCounter++] = frequencys; 

		 Debug.debug(debud_level_DEBUG,"FrequencyDetails addToMultiFrequencyWaveMap"
			+ " frequencyMultiWaveMapCounter "	 +  (AGBCVariables.frequencyMultiWaveMapCounter-1)
			+ " frequencys.length "	 +  frequencys.length
			+ " frequencys: "+ Arrays.toString(frequencys));	
	}
