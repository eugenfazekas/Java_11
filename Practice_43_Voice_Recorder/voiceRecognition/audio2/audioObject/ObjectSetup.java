package voiceRecognition.audio2.audioObject;
...
public class ObjectSetup {
	...
	private boolean voiceRecognitionScanData;
	private boolean voiceFrequencyGramRecognitionData;
	...
	private boolean voiceScanRecognition;
	private boolean voiceFrequencyGramRecognition;
	...
	private void buildSetupObject() {
		...
		if(AppSetup.voiceRecognitionScanData)
			setVoiceRecognitionScanData(true);
		
		if(AppSetup.voiceRecognitionFrequencyGramData)
			setVoiceRecognitionFrequencyGramData(true);
		...
		if(AppSetup.voiceScanRecognition)
			setVoiceScanRecognition(true);
		
		if(AppSetup.voiceFrequencyGramRecognition)
			setVoiceFrequencyGramRecognition(true);
	}
	...
	public boolean isVoiceRecognitionScanData() {
		return voiceRecognitionScanData;
	}

	public ObjectSetup setVoiceRecognitionScanData(boolean voiceRecognitionScanData) {
		this.voiceRecognitionScanData = voiceRecognitionScanData;
		return this;
	}

	public boolean isVoiceRecognitionFrequencyGramData() {
		return voiceFrequencyGramRecognitionData;
	}

	public ObjectSetup setVoiceRecognitionFrequencyGramData(boolean voiceFrequencyGramRecognitionData) {
		this.voiceFrequencyGramRecognitionData = voiceFrequencyGramRecognitionData;
		return this;
	}
	...
	public boolean isVoiceScanRecognition() {
		return voiceScanRecognition;
	}

	public ObjectSetup setVoiceScanRecognition(boolean voicescanRecognition) {
		voiceScanRecognition = voicescanRecognition;
		return this;
	}
	
	public boolean isVoiceFrequencyGramRecognition() {
		return voiceFrequencyGramRecognition;
	}

	public ObjectSetup setVoiceFrequencyGramRecognition(boolean voicefrequencyGramRecognition) {
		voiceFrequencyGramRecognition = voicefrequencyGramRecognition;
		return this;
	}
