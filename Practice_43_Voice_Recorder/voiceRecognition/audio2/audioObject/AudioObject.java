...
public class AudioObject {
	...
	private String voiceReconitionFrequencgramArray;
	...
	private int[][] voiceReconitionCheckFrequencgramArray;
	...
	public int[][] getFrequencyMultiMap() {
		return frequencyMultiMap;
	}

	public AudioObject setFrequencyMultiMap(int[][] frequencyMultiMap) {
		this.frequencyMultiMap = frequencyMultiMap;
		return this;
	}
	...
	public String getVoiceReconitionFrequencgramArray() {
		return voiceReconitionFrequencgramArray;
	}

	public AudioObject setVoiceReconitionFrequencyGramArray(String voiceReconitionFrequencgramArray) {
		this.voiceReconitionFrequencgramArray = voiceReconitionFrequencgramArray;
		return this;
	}
	...
	public int[][] getVoiceReconitionCheckFrequencyGramArray() {
		return voiceReconitionCheckFrequencgramArray;
	}

	public AudioObject setVoiceReconitionCheckFrequencgramArray(int[][] voiceReconitionCheckFrequencgramArray) {
		this.voiceReconitionCheckFrequencgramArray = voiceReconitionCheckFrequencgramArray;
		return this;
	}
