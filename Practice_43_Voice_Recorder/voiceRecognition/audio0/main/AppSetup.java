...
public class AppSetup {
	...
	//Thread Sleep Times
	public static int AUDIO_ANALYSIS_THREAD_SLEEP = 50;
	public static int THREAD_MANAGEMENT_THREAD_SLEEP = 20;
		
	//FFT limits
	public static float FFT_MAGNITUDE_LIMIT = 0.8f;
	
	//Recomended lower then 500 at simple avg frequencymap.
	...
	public static float VOICE_RECOGNITION_FREQUENCYGRAM_CORRECTION_KONSTANT = 1.0f;
	...
	public static boolean voiceRecognitionFrequencyGramData;
	...
	public static boolean voiceFrequencyGramRecognition;
	...
	public static void activateSaveNamedRecordsProfile() {
	    ...
	    voiceRecognitionFrequencyGramData = true; save = true;
	} 
	...
	public static void activateVoiceRecognitionProfile(){
	    ...
	    voiceScanRecognition = true;  voiceFrequencyGramRecognition = true ; voiceRecognitionPointsData = true; 
	    voiceRecognitionSlopesData = true;  voiceRecognitionAreaData = true; voiceRecognitionScanData = true;
	    voiceRecognitionFrequencyGramData = true;
	}
