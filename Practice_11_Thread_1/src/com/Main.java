...
*/
    ...
    private static void demo1_thread() {
        ...
        IntStream.range(21, 24).peek(Main::doSomething).forEach(System.out::println);
    ...
    private static class AThread extends Thread {
        ...
        public void run() {
            IntStream.range(i1, i2).peek(Main::doSomething).forEach(System.out::println);
        }
    }
    ...
    private static void demo3_lambda1() {
        ...
        Thread thr1 = new Thread(() -> IntStream.range(1, 4).peek(Main::doSomething).forEach(System.out::println));
        thr1.start();

        Thread thr2 = new Thread(() -> IntStream.range(11, 14).peek(Main::doSomething).forEach(System.out::println));
        thr2.start();
    ...
    private static void demo3_lambda2() {
        ...
        System.out.println("Id= "+thr1.getId()+" thr1.getName= "+thr1.getName()+" priority= "+thr1.getPriority()+"thr1.getState= "+ thr1.getState());

        System.out.println("Id= "+thr2.getId()+" thr2.getName= "+thr2.getName()+" priority= "+thr2.getPriority()+"thr2.getState= "+ thr2.getState());
    }
