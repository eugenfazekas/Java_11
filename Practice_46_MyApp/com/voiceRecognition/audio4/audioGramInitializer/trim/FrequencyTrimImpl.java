...
import com.voiceRecognition.audio5.audioGramBuilder.AudioGramObject;
...
public class FrequencyTrimImpl implements AudioTrim{
	...
	public void buildTrimSequenceBorders(int id, int[] inputIntArray) {
		...
		if(VoiceRecognitionAppSetup.voiceAreaRecognition && VoiceRecognitionAppSetup.frequencyTrim ) {
