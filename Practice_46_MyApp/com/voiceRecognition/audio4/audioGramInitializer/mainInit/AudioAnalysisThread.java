package com.voiceRecognition.audio4.audioGramInitializer.mainInit;
...
import com.voiceRecognition.audio1.logical.DeleteOrNotActionLogic;
import com.voiceRecognition.audio1.logical.EntryPointMethods;
import com.voiceRecognition.audio2.audioObject.AudioObject;
import com.voiceRecognition.audio4.audioGramInitializer.trim.AudioTrimSelector;
import com.voiceRecognition.audio5.audioGramBuilder.MultiAnalysisBuilder;
...
public class AudioAnalysisThread implements MyThread{
	...
	private void  buildSpektrogramFromAudioFile(int id) {
	    ...
	    VoiceRecognitionMainStart.setStopAllThreads("AudioAnalysisThread buildSpektrogramFromAudioFile");
	}
	...
	private void buildSequenceFromFrequncyListFromFile(int id) {
	    ...
	    VoiceRecognitionMainStart.setStopAllThreads("AudioAnalysisThread buildSequenceFromFrequncyListFromFile");
	}
	...
	private void buildTestAudioSequence(int id) {
    	...
    	Debug.debug(debud_level_DEBUG,"AudioAnalysisThread buildTestSequence inputFileName: "+id 
    		+ ", AppSetup.multiAnalysis: " + VoiceRecognitionAppSetup.multiAnalysis);
 
	    mainAnalysisBuilder(id);
	    
	    saveMultiAudioFeatures(id);
	    
	    VoiceRecognitionMainStart.setStopAllThreads("AudioAnalysisThread buildTestAudioSequence");
	}
	...
	private void timeFixedSoundRecorder(int id) {		
	    ...
	    VoiceRecognitionMainStart.setStopAllThreads("AudioAnalysisThread timeFixedSoundRecorder");
	}
	...
	private void saveMultiAudioFeatures(int id) {
		...
		if(SaveMultiAudioFeatures.building.get() == false) 
			SaveMultiAudioFeatures.mainSave(VoiceRecognitionAppSetup.BASE_AUDIO_PATH,id);
