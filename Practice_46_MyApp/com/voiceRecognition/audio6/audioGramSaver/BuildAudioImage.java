...
public class BuildAudioImage {
	...
	static BufferedImage buildVoiceCompareImage(int[] map1, int[] map2, int height) {
	    ...
	    Debug.debug(debug_level_INFO,"AudioGramSaver buildVoiceCompareImage getRoundToOneHundred length: "+length*2 
	    ...
	    for (int x = 2; x < length*2; x = x+2) {
	    	...
	    	Debug.debug(debud_level_DEBUG,"buildImage x1: "+x + " waveMap.length: "+map1.length);
	    ...
	    for (int x = 3; x < length*3; x=x+3) {
			...
			Debug.debug(debud_level_DEBUG,"buildImage x2: "+x + " waveMap[x]: "+map2[x]+ ", map2[x+1]: "+map2[x+1]
